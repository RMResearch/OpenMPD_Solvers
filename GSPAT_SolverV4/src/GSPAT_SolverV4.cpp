...
Solver* GSPAT_V4::createSolver(int numTransducers) {
...
void GSPAT_V4::printMessage_GSPAT(const char* str) {
	if (_printMessage_GSPAT) _printMessage_GSPAT(str);
}
void GSPAT_V4::printError_GSPAT(const char* str) {
	if (_printError_GSPAT) _printError_GSPAT(str);
}
void GSPAT_V4::printWarning_GSPAT(const char* str) {
	if (_printWarning_GSPAT) _printWarning_GSPAT(str);
}

void GSPAT_V4::RegisterPrintFuncs(void(*p_Message)(const char*), void(*p_Warning)(const char*), void(*p_Error)(const char*)) {
