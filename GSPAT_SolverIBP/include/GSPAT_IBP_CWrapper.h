#ifndef _GSPAT_IBP_CWRAPPER
#define _GSPAT_IBP_CWRAPPER
...
extern "C" {
	...
	static const int GSPAT_RowMajorAlignment = GSPAT::RowMajorAlignment;
		...
		_GSPAT_Export bool GSPAT_IBP_CWrapper_Initialize();
		_GSPAT_Export bool GSPAT_IBP_CWrapper_Release();
		_GSPAT_Export void GSPAT_IBP_CWrapper_RegisterPrintFuncs(void(*p_Message)(const char*), void(*p_Warning)(const char*), void(*p_Error)(const char*));
		...
		_GSPAT_Export int GSPAT_IBP_CWrapper_getNumGeometries(GSPAT_Solution_Handler s);
		_GSPAT_Export int GSPAT_IBP_CWrapper_getNumPoints(GSPAT_Solution_Handler s);
		_GSPAT_Export void GSPAT_IBP_CWrapper_finalMessages(GSPAT_Solution_Handler s, unsigned char** out);
		_GSPAT_Export float* GSPAT_IBP_CWrapper_finalArrayPhases(GSPAT_Solution_Handler s);
		_GSPAT_Export float* GSPAT_IBP_CWrapper_finalArrayAmplitudes(GSPAT_Solution_Handler s);
		_GSPAT_Export float* GSPAT_IBP_CWrapper_finalHologramReIm(GSPAT_Solution_Handler s);
		_GSPAT_Export void GSPAT_IBP_CWrapper_readPropagators(GSPAT_Solution_Handler s, float* singlePointFields, float* singlePointFieldsNormalised, int numGeometries = 1);
		_GSPAT_Export void GSPAT_IBP_CWrapper_readMatrixR(GSPAT_Solution_Handler s, float* R, int numGeometries = 1);
		_GSPAT_Export void GSPAT_IBP_CWrapper_readTargetPointsReIm(GSPAT_Solution_Handler s, float* targetPoints, int numGeometries = 1);
};
#endif