...
GSPAT::Solver* GSPAT_Naive::createSolver(int numTransducers) {
...
void GSPAT_Naive::printMessage_GSPAT(const char* str) {
	if (_printMessage_GSPAT) _printMessage_GSPAT(str);
}
void GSPAT_Naive::printError_GSPAT(const char* str) {
	if (_printError_GSPAT) _printError_GSPAT(str);
}
void GSPAT_Naive::printWarning_GSPAT(const char* str) {
	if (_printWarning_GSPAT) _printWarning_GSPAT(str);
}

void GSPAT_Naive::RegisterPrintFuncs(void(*p_Message)(const char*), void(*p_Warning)(const char*), void(*p_Error)(const char*)) {
