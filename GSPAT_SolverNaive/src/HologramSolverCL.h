...
protected:
	...
	*/
	...
	void solvePhases_Naive(HologramSolution* solution);
...
private: 
	...
	cl_program program;
	cl_kernel fillAllPointHologramsKernel, solveNaiveKernel,  addHologramsKernel, discretiseKernel;	
	...
	/** amplitudeCorrections: Describes the amplitude correction required by each transducer.
	    Some transducers might be weaker, some are broken/noisy, so we set amplitude to 0. 
		This data is used during the discretization stage to build AsierInho messages.*/
