...
extern "C" {
	...
	static const int GSPAT_RowMajorAlignment = GSPAT::RowMajorAlignment;
		...
		_GSPAT_Export void GSPAT_Naive_CWrapper_setBoardConfig(GSPAT_Solver_Handler solver, float* transducerPositions, float* transducerNormals, int* transducerToPINMap, int* phaseAdjust, float* amplitudeAdjust, int numDiscreteLevels = 128) ;
