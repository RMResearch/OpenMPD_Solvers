...
//#define maxA 1.0f				//The texture's maximum value
//#define distance_max_A 0.02f	//The maximum value was for a point at distance_max_A meters infront of the transducer
//#define P_ref 8.02f			//This will allow us to map from values stored to actual values in Pascals.
